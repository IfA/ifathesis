...
\end{enumerate}
%Alternativ kann auch die sog. Harvard-Nummerierung verwendet werden. Dabei wird ein K?rzel aus drei Buchstaben (des einzigen bzw. der ersten drei Autoren) und zwei Ziffern des Erscheinungsjahres gebildet.
%
%Beispiele
%
...
% [B?h-88]	B?hler, H.: Anti-Reset-Windup-Ma?nahmen bei stetigen Reglern.
...
\begin{table*}[h]
	\centering
		...
		\begin{tabular}{lll}%{p{4cm}p{4cm}p{4cm}}
			...
			\bottomrule
		\end{tabular}	
\end{table*}\fixme{table alignment, size, combine cells?}
