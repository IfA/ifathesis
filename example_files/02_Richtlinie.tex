...
Der Umgang mit Bildern, Tabellen, Gleichungen und Literaturstellen ist im \autoref{sec:FormDerArbeit} genauer erläutert.
...
\autoref{tab:SeitennzaehlungUndReihenfolge} fasst die anzuwendenden Nummerierungsarten für die einzelnen Abschnitte der wissenschaftlichen Arbeit zusammen.
...
Bilder sind mit Bildunterschriften zu versehen (Bezeichnung "'Abbildung"', lfd. Nr., aussagefähige Bezeichnung; z.B. Abb. 3.1: Strecke mit PID-Regler).
Tabellen erhalten eine Tabellenüberschrift (Bezeichnung "'Tabelle"', lfd. Nr., aussagefähige Bezeichnung; z.B. Tab. 3.1: Aufwand bei Programmentwicklung).
