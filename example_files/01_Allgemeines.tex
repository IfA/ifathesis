...
Um die automatische Generierung eines Abkürzungs- und Symbolverzeichnises zu benutzen, müssen Sie zusätzlich zum pdftex-Kompiler den makeindex-Kompiler benutzen. Dieser ist wie folgt entweder manuell oder im TeXnicCenter eingebunden aufzurufen\footnote{Das ist ein Beispiel für das Betriebssystem Windows bei Verwendung von Miktex 2.9. Wie der Befehl auf anderen Betriebssystemen und \LaTeX-Distributionen genau lautet, entnehmt bitte einer Internetrecherche.}:

\noindent \begin{center} \verb|makeindex.exe "%tm.nlo" -s nomencl.ist -o "%tm.nls"| \end{center}
