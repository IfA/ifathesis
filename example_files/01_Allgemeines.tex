...
\begin{description}
  ...
  \item[ifaUserListings] Dateiname einer Datei, die zusätzliche Verzeichnisse definiert/ausgibt, die nach dem Abbildungs-, Tabellen- und Quellcodeverzeichnis eingebunden werden sollen
