...
\let\bibliography=\ifaReferences
\bibliography{bibliography}						       % Hier den Dateinamen des Literaturverzeichnisses angeben (ohne *.bib-Endung)

% Bibliography Style
% \ifaBibliographyStyle{alpha}                         % Hier kann der Bibliographiestil eingestellt werden

% Soll das Literaturverzeichnis vor oder nach dem Anhang aufgeführt werden?
\ifaBibliographyBeforeAppendix{true}	% Mögliche Optionen: true, false
