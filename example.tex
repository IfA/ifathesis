...
\ifaAuthor{Heinrich Grabow}                         % author of the thesis
\ifaAuthorBirthday{20.02.1980}                      % date of birth
\ifaAuthorBirthplace{Lutherstadt Eisleben}          % place of birth
\ifaAuthorCourse{Mechatronik}                       % study program
\ifaAuthorYearOfMatriculation{2002}                 % year of immatriculation
...
\ifaDayOfSubmission{21.03.2009}                        % the day the thesis is submitted
