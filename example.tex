...
% Im Falle einer Dissertation wird mit diesem Schalter der die Phase der Arbeit ('Gutachten' vs. 'Pflichtexemplare') festgelegt
% \ifaDissertationStage{Gutachten}
...
% Im Falle einer Dissertation wird mit diesem Schalter der Vorsitzende der Prüfungskommission angegeben
% \ifaChair{}
...
% Im Falle einer Dissertation kann mit diesem Schalter falls gewünscht der Tag der Verteidigung angegeben werden
% \ifaDayOfDefense{}
...
%\ifaAcknowledegments{}
%\ifaIncludeBeforeTitlePage{}
%\ifaIncludeAfterTitlePage{}
