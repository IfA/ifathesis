...
\ifaAuthor{Vorname Nachname}                           % author of the thesis
\ifaAuthorBirthday{dd.mm.yyyy}                         % date of birth
\ifaAuthorBirthplace{Stadtname}                        % place of birth
\ifaAuthorCourse{Elektrotechnik}                       % study program
\ifaAuthorYearOfMatriculation{yyyy}                    % year of immatriculation
\ifaKeywords{Diplomarbeit, Web, SPS, Security, XML, UI, I40}    % Keywords included in pdf-file. Could be found e.g. by Windows file search.
\ifaTitleDE{Teleautomation, Chancen und Risiken}       % geman title of the thesis
...
\ifaSupervisorA{Dipl.-Ing. Vorname Nachname}
\ifaSupervisorB{Dipl.-Ing. Vorname Nachname}
\ifaSupervisorC{PD Dr.-Ing. Vorname Nachname}
%\ifaSupervisorD{}
%\ifaSupervisorE{}

\ifaProfessor{Prof. Dr. techn. Klaus Janschek}         % supervising professor as indicated on the topic description
\ifaDayOfSubmission{dd.mm.yyyy}                        % the day the thesis is submitted
