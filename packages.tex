...
\RequirePackage[square]{natbib}		% Paket zum Personalisieren von Zitaten im Text. Fuer eckige Klammern [square]
...
% zur scrbook-Klasse passendes Koma-Skript- Paket zum Einbinden einer Kopf-/FuÃŸzeile:		
\RequirePackage[
...
%\RequirePackage[draft]{fixme}	% Zum Einfügen von Kommentaren im Text, z.B. Erinnerungen welche Stellen noch bearbeitet werden müssen.
								...
								% Beim Kompillieren wird eine Zusammenfassung gegeben, wie viele fixme-Notizen noch im Dokument sind.
