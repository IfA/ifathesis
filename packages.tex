...
\RequirePackage[OT1, T1]{fontenc}       % EC-Fonts verwenden, sodass Wörter mit Umlauten getrennt werden, OT1 wird für opensans header benötigt
...
\RequirePackage[section]{placeins} % Platziert zu einem Abschnitt gehörende Floating-Objekte spätestens am Ende des Abschnitts
\RequirePackage{flafter}           % Platziert Grafiken erst nachdem sie das erste mal im Text referenziert wurden.
...
\RequirePackage[htt]{hyphenat}  % Erlaubt die automatische Silbentrennung in texttt, allerdings werden Bindestriche (-) sowie Leerzeichen als geschützt behandelt
